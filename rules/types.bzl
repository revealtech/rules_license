...
# https://github.com/bazelbuild/bazel-skylib/blob/7209de9148e98dc20425cf83747613f23d40827b/lib/types.bzl.
# We use the types functions in some debug code. However, I did not want to add a new dependency to this forked repo.
